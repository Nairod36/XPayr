...
export default function PaymentScreen() {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Paiement USDC</Text>
      <Text style={styles.subtitle}>Envoyez des USDC à un contact ou une adresse.</Text>
      <View style={styles.form}>
        <TextInput style={styles.input} placeholder="Adresse du destinataire" placeholderTextColor="#666" />
        <TextInput style={styles.input} placeholder="Montant" placeholderTextColor="#666" keyboardType="numeric" />
